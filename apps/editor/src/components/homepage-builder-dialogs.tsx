...
export function HomepagePublishDialog({
  ...
  return (
    <dialog
      ref={dialogRef}
      onClose={onClose}
      className="w-full max-w-md rounded-lg border border-zinc-200 bg-white p-0 shadow-lg backdrop:bg-zinc-900/40"
    ...
    >
      <div className="border-b border-zinc-200 px-5 py-4">
        ...
        <p className="mt-1 text-sm text-zinc-600">
          Taslak composition canlı ana sayfaya atomik olarak uygulanır.
        </p>
      </div>
...
export function HomepagePreviewDialog({
  ...
  return (
    <dialog
      ref={dialogRef}
      onClose={onClose}
      className="w-full max-w-4xl rounded-lg border border-zinc-200 bg-zinc-50 p-0 shadow-lg backdrop:bg-zinc-900/40"
